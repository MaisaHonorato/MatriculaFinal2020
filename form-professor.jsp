...
<%@page import="modelo.Funcionario"%><%@page import="controle.DAOProfessor"%>
...
<form action="add-professor.jsp" method="get">
 ...
 <label for="Dataadmissao">Data de Admissão:</label> <input type="text" name="dataAdmissao"/> <br/>
	...
	<select name="disciplina">
		<%for(Disciplina s : DAODisciplina.listarDisciplina() ){%>
